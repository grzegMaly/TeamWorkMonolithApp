...
public class BOMSArchiveRestoreBoardRepoTest {
    ...
    @Test
    @DisplayName("Restore Board User Not Found Test")
    void restoreBoardUserNotFoundTest() {
    ...
    @Test
    @DisplayName("Restore Board Board Already Restored Test")
    void restoreBoardBoardAlreadyArchivedTest() {
